...
@section('title', 'En attente de decision')

@section('content')
<div class="content-wrapper">
    <div class="content-header row">
        <div class="mb-2 col-md-6 col-12">
            <h3 class="content-header-title">DE en attente de décision de sanction</h3>
        </div>
        <div class="mb-2 col-md-6 col-12">
                    ...
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-6 col-12">
                                <h4 class="card-title mt-1">Liste des demandes en attente de décision</h4>
                            </div>
                            <div class="col-md-6 col-12">
