...
@section('title', 'DE répondues')

@section('content')
<div class="content-wrapper">
    <div class="content-header row">
        <div class="mb-2 col-md-6 col-12">
            <h3 class="content-header-title">{{ $reponse_supplementaires ? 'DE à fournir plus d\'informations':'Répondre aux demandes' }}</h3>
        </div>
        <div class="mb-2 col-md-6 col-12">
                ...
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb float-md-right">
                        ...
                        <li class="breadcrumb-item active">
                            ...
                            {{ $reponse_supplementaires ? 'DE en attente d\'informations':'DE repondues' }}
                        </li>
                    </ol>
                </div>
            </div>
                    ...
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-3 col-12">
                                <h4 class="card-title">
                                    {{ $reponse_supplementaires ? 'Invité à fournir plus d\'informations':'DE déjà répondues' }}
