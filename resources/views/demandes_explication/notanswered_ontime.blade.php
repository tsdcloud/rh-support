...
@section('title', 'DE non répondues, dans les delais')
            ...
            <div class="row breadcrumbs-top">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb float-md-right">
                        ...
                        <li class="breadcrumb-item active">
                            DE non repondues, dans les delais
                        </li>
                    </ol>
                </div>
            </div>
                                            ...
                                            @if($demande->ontime())
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        @else
                                                            <span class="badge badge-success"><i class="ft-x"></i> Non répondu dans les delais</span>
                                                        @endif
                                                    </td>
                                                    <td>
