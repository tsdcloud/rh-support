...
@section('title', 'DE répondues dans les délais')
                                        ...
                                        @foreach ($demandes as $demande)
                                            @if($demande->ontime())
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if ($demande->reponse)
                                                            <span class="badge badge-success"><i class="ft-check"></i> Répondue dans les delais</span>
                                                        @else
                                                            <span class="badge badge-danger"><i class="ft-x"></i> Non répondue</span>
                                                        @endif
                                                    </td>
                                                    <td>
