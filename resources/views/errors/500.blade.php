...
<html class="loading" lang="en" data-textdirection="ltr">
  ...
  <head>
    ...
    <title>500 - Erreur du serveur</title>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('app-assets/css/pages/error.min.css') }}">
    <!-- END: Page CSS-->
                    ...
                    <div class="card-content">
                        ...
                        <div class="row py-2">
                            <div class="col-12 col-sm-12 col-md-12 mb-1">
                                <a href="{{ route('home')}}" class="btn btn-primary btn-block"><i class="ft-home"></i> Accueil</a>
                            </div>
                        </div>
                    </div>
