...
<div class="content-wrapper">
    <div class="content-header row">
        <div class="mb-2 col-md-6 col-12">
            <h3 class="content-header-title">Motifs de sanction</h3>
        </div>
        <div class="mb-2 col-md-6 col-12">
                                        ...
                                        <div class="text-left modal fade" id="addmotif" tabindex="-1" role="dialog" aria-labelledby="addmotif"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="{{ route('motifs.sanction.store') }}" method="post">
                                                        @csrf
                                                        ...
                                                        <div class="text-left modal fade" id="editmotif{{ $motif->id }}" tabindex="-1" role="dialog" aria-labelledby="editmotif{{ $motif->id }}"
                                                            ...
                                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <form action="{{ route('motifs.sanction.update', $motif->id) }}" method="post">
                                                                        @csrf
                                                                        @method('PUT')
                                                                        <div class="modal-body">
                                                                            <div class="form-body">
